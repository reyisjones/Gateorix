...
function HomePage() {
  ...
  const handleGreet = async () => {
    ...
    try {
      ...
      setError(isTauri ? `Sidecar error: ${err}` : "Cannot reach backend. Is the F# bridge running? (dotnet run -- --http)");
  ...
  return (
    <div className="main-content">
      ...
      <p className="page-subtitle">A React frontend + F# backend desktop app.</p>
